                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-[400px]">
                             ...
                             <div className="grid grid-cols-2 md:grid-cols-4 gap-2 w-full mt-6 pt-6 border-t border-slate-50 shrink-0">
                                ...
                                <div className="text-center"><div className="text-[10px] text-slate-400 font-bold uppercase mb-1">成交率</div><div className="text-xl font-black text-pink-600 tabular-nums">{totals.marketing.pastAppointments > 0 ? ((totals.marketing.closed / totals.marketing.visited) * 100).toFixed(0) : 0}%</div></div>
                             </div>
                        </div>
